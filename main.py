...
students = {"Luke S": "data/luke_grades.json",
            "Mikhail R": "data/mikhail_grades.json", "Paul N": "data/pauln_grades.json", "JQ":"data/john_grades.json"}
...
print(f"Cumulative Unweigted GPA:\n\n{pd.concat(cumulative_unweighted).sort_values()}\n\n")
print(f"Cumulative Weighted GPA:\n\n{pd.concat(cumulative_weighted).sort_values()}\n\n")
